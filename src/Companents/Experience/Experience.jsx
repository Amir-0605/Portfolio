...
const Experience = () => {
    return (
        <section id='Experience' className='pt-19'>
            <div className='container'>
                <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}>
                    ...
                    <div className='flex items-center justify-center pb-50'>
                        ...
                        <div id='experience' className='border p-8 border-blue-400 w-90 h-80 absolute translate-x-75 -translate-y-40 dark:bg-white z-10 rounded-xl hover:scale-105 duration-300 ease-out hover:shadow-lg shadow-cyan-300'>
                            <p className='text-cyan-500 mb-2'>Feb 2026 - March 2026</p>
                            <h1 className='text-2xl mb-2'>Frontend Intern</h1>

                            <p className='mb-2 text-xl'>Data Life Centre </p>
                            <p>Assisted in teaching and guiding students
                                in frontend technologies such as HTML, CSS, JavaScript and React.
                                Gained valuable experience in mentoring and working within a professional development
                                environment.</p>
                        </div>
