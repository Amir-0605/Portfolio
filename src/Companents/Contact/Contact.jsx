            ...
            <div className='container'>
                <div className='flex flex-col gap-3 items-center'>
                    ...
                    <div className='grid grid-cols-2 gap-5 mt-4 mb-5'>
                        <a href='https://facebook.com/AmirAshirbaev' className='flex text-xl cursor-pointer items-center gap-22 border border-cyan-500 rounded-2xl p-5 shadow-lg hover:bg-blue-500 hover:text-[#fff] hover:shadow-lg hover:shadow-cyan-500 duration-300 ease-out hover:scale-105'>
                        ...
                        <a href='mailto:aashirbaev89@gmail.com' className='flex text-xl cursor-pointer items-center gap-25 border border-cyan-500 rounded-2xl p-5 shadow-lg hover:bg-blue-500 hover:text-[#fff] hover:shadow-lg hover:shadow-cyan-500 duration-300 ease-out hover:scale-105'>
